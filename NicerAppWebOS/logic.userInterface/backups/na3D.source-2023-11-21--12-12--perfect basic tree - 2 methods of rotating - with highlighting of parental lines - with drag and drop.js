            ...
            if (it.model && p && p.model) {
                ...
                it.model.position.x = Math.round(
                   ...
                   // + ( ( it.columnOffsetValue * m))
                    ...
                    //+ p.columnOffsetValue * (it.columnOffsetValue*100)// * Math.abs(2000-(it.level * 50))
                    //+ (it.columnOffsetValue * 100)
                ...
                it.model.position.y = Math.round(
                    ...
                    //+ p.rowOffsetValue * (it.rowOffsetValue*100)// * Math.abs(2000-(it.level * 50))
                ...
                //debugger;
                it.model.position.x = it.leftRight * (it.column+1) * 100;
                it.model.position.y = it.upDown * (it.row-1) * 100;
