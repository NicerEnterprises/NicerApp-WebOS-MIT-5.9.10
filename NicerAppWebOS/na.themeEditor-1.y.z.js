na.te = na.themeEditor = {
    ...
    addTheme : function (event) {
        ...
        $('.na_themes_dropdown__themes > .vividDropDownBox_selector > div').append(opt);
        na.te.s.c.oldThemeNames.push (opt.text);
        
        
        var html = '<div id="theme_'+i+'_div"><input id="theme_'+i+'" class="themeItem" type="text" onclick="na.te.themeNameSelected(\'theme_'+i+'\')" onchange="na.te.themeNameChanged('+i+', \'theme_'+i+'\')" value="new theme"></div>';
        $('#themePermissionsControls').append(html);
