    ...
    setSiteLoginLogout : function () {
        $('#btnLoginLogout').hover(function() {
            ...
            html = 
                ...
                +'<div id="labelLoggedInAs" class="siteLoginLogout_label" style="grid-column:1;grid-row:1">Loggged in as : </div>'
                +'<div id="loggedInAs" class="siteLoginLogout_labelText" style="grid-column:2;grid-row:1">'+$.cookie('cdb_loginName').replace(/.*___/g,'').replace(/__/g,' ')+'</div><br/>'
